...
::: warning 警告 如果你使用的是「[Magisk Delta](https://huskydg.github.io/magisk-files/)」，则[无法使用](https://huskydg.github.io/magisk-files/docs/faq.html#should-i-install-shxxxxo-module-to-hide-root)此模块！ :::
