import{_ as s,c as n,o as a,a as l}from"./app.1dd0032b.js";const m=JSON.parse('{"title":"Magisk 工具","description":"","frontmatter":{},"headers":[{"level":3,"title":"magiskboot","slug":"magiskboot","link":"#magiskboot","children":[]},{"level":3,"title":"magiskinit","slug":"magiskinit","link":"#magiskinit","children":[]},{"level":3,"title":"magiskpolicy","slug":"magiskpolicy","link":"#magiskpolicy","children":[]},{"level":3,"title":"magisk","slug":"magisk","link":"#magisk","children":[]},{"level":3,"title":"su","slug":"su","link":"#su","children":[]},{"level":3,"title":"resetprop","slug":"resetprop","link":"#resetprop","children":[]}],"relativePath":"tools.md","lastUpdated":1672592264000}'),e={name:"tools.md"},p=l(`<h1 id="magisk-工具" tabindex="-1">Magisk 工具 <a class="header-anchor" href="#magisk-工具" aria-hidden="true">#</a></h1><p>Magisk 为开发人员提供了大量安装工具、守护程序和实用程序。本文档涵盖了4个二进制文件和所有包含的小程序。二进制文件和小程序如下所示：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">magiskboot                 /* binary */</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    Supported formats: gzip zopfli xz lzma bzip2 lz4 lz4_legacy lz4_lg </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="magiskinit" tabindex="-1">magiskinit <a class="header-anchor" href="#magiskinit" aria-hidden="true">#</a></h3><p>这个二进制文件将替换 Magisk 补丁启动映像的 ramdisk 中的 <code>init</code>。它最初是为支持以 system-as-root 的设备而创建的，但该工具被扩展为支持所有设备，并成为 Magisk 的关键部分。更多详细信息可以在 <a href="./details.html#magisk-booting-process">Micsk Booting Process</a> 中的 <strong>Pre-Init</strong> 部分找到。</p><h3 id="magiskpolicy" tabindex="-1">magiskpolicy <a class="header-anchor" href="#magiskpolicy" aria-hidden="true">#</a></h3><p>（此工具别名为 <code>supolicy</code>，以与 SuperSU 的 sepolicy 工具兼容）</p><p>高级开发人员可以使用此工具修改 SELinux 策略。在像 Linux 服务器管理员这样的常见场景中，他们会直接修改 SELinux 策略源（<code>*.te</code>）并重新编译 <code>sepolicy</code> 二进制文件，但在 Android 上，我们直接修补二进制文件（或运行时策略）。</p><p>All processes spawned from the Magisk daemon, including root shells and all its forks, are running in the context <code>u:r:magisk:s0</code>. The rule used on all Magisk installed systems can be viewed as stock <code>sepolicy</code> with these patches: <code>magiskpolicy --magisk &#39;allow magisk * * *&#39;</code>.</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: ./magiskpolicy [--options...] [policy statements...]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h3 id="su" tabindex="-1">su <a class="header-anchor" href="#su" aria-hidden="true">#</a></h3><p>MagiskSU 入口点 <code>magisk</code> 的小程序。不错的旧 <code>su</code> 命令。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: su [options] [-] [user [argument...]]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">Options:</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>Note: even though the <code>-Z, --context</code> option is not listed above, the option still exists for CLI compatibility with apps designed for SuperSU. However the option is silently ignored since it&#39;s no longer relevant.</p><h3 id="resetprop" tabindex="-1">resetprop <a class="header-anchor" href="#resetprop" aria-hidden="true">#</a></h3><p><code>magisk</code> 的小程序。高级系统属性操作实用程序。查看 <a href="./details.html#resetprop">Resetprop详细信息</a> 以了解更多背景信息。</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: resetprop [flags] [options...]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">Options:</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,25),o=[p];function t(i,c,r,C,A,y){return a(),n("div",null,o)}const D=s(e,[["render",t]]);export{m as __pageData,D as default};
