import{_ as s,c as n,o as a,a as l}from"./app.3dfd33b5.js";const d=JSON.parse('{"title":"Magisk 工具","description":"","frontmatter":{},"headers":[{"level":2,"title":"magiskboot","slug":"magiskboot","link":"#magiskboot","children":[]},{"level":2,"title":"magiskinit","slug":"magiskinit","link":"#magiskinit","children":[]},{"level":2,"title":"magiskpolicy","slug":"magiskpolicy","link":"#magiskpolicy","children":[]},{"level":2,"title":"magisk","slug":"magisk","link":"#magisk","children":[]},{"level":2,"title":"su","slug":"su","link":"#su","children":[]},{"level":2,"title":"resetprop","slug":"resetprop","link":"#resetprop","children":[]},{"level":2,"title":"参考链接","slug":"参考链接","link":"#参考链接","children":[]}],"relativePath":"tools.md","lastUpdated":1675692441000}'),p={name:"tools.md"},e=l(`<h1 id="magisk-工具" tabindex="-1">Magisk 工具 <a class="header-anchor" href="#magisk-工具" aria-hidden="true">#</a></h1><p>Magisk 为开发人员提供了大量安装工具、守护程序和实用程序。本文档涵盖了4个二进制文件和所有包含的小程序。二进制文件和小程序如下所示：</p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">magiskboot                 /* binary */</span></span>
...
<span class="line"><span style="color:#A6ACCD;">   --help            显示policy语句的帮助消息</span></span>
<span class="line"><span style="color:#A6ACCD;">   --load FILE       \\ 从FILE加载sepolicy</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="magisk" tabindex="-1">magisk <a class="header-anchor" href="#magisk" aria-hidden="true">#</a></h2><p>当使用名称 <code>magisk</code> 调用 magisk 二进制文件时，它作为一个实用工具，具有许多助手函数和几个 Magisk 服务的入口点。</p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: magisk [applet [arguments]...]</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="su" tabindex="-1">su <a class="header-anchor" href="#su" aria-hidden="true">#</a></h2><p>MagiskSU 入口点 <code>magisk</code> 的小程序。不错的旧 <code>su</code> 命令。</p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: su [options] [-] [user [argument...]]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">Options:</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="tip custom-block"><p class="custom-block-title">注意</p><p>尽管上面没有列出 <code>-Z, --context</code> 选项，但该选项仍然存在，以便与为 SuperSU 设计的应用程序进行 CLI 兼容。然而，该选项被默默忽略，因为它不再相应。</p></div><h2 id="resetprop" tabindex="-1">resetprop <a class="header-anchor" href="#resetprop" aria-hidden="true">#</a></h2><p><code>magisk</code> 的小程序。高级系统属性操作实用程序。查看 <a href="./details.html#重置属性-resetprop">Resetprop 详细信息</a> 以了解更多背景信息。</p><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: resetprop [flags] [options...]</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">选项:</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="参考链接" tabindex="-1">参考链接 <a class="header-anchor" href="#参考链接" aria-hidden="true">#</a></h2><ul><li><a href="https://topjohnwu.github.io/Magisk/tools.html" target="_blank" rel="noreferrer">Magisk Tools</a>（官方）</li><li><a href="https://e7kmbb.github.io/Magisk/tools.html" target="_blank" rel="noreferrer">Magisk 工具</a></li></ul>`,27),o=[e];function t(c,i,r,A,C,y){return a(),n("div",null,o)}const g=s(p,[["render",t]]);export{d as __pageData,g as default};
